...
"""
Modify from Lovasz-Softmax and Jaccard hinge loss in PyTorch
...
if __name__ == "__main__":
    ...
    loss_lovasz = lovasz_softmax(torch.nn.functional.softmax(input, dim=1), label, ignore=0)
    loss_ce = torch.nn.functional.cross_entropy(input, label)
    print(1)