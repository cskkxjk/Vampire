...
class VAMPIRELightningModel(BaseVAMPIRELightningModel):
    ...
    def __init__(self, **kwargs):
        ...
        self.loss_weights = [1., 0., 0., 0., 0.]
        self.model = VAMPIRE2(self.backbone_conf,
                                  self.head_conf)

if __name__ == '__main__':
    # train
    # python src/exps/nuscenes/ablation/vampire2_r50_256x704_24e_lss_inpaintor_depth.py --amp_backend native -b 1 --gpus 8
    # test
    # python src/exps/nuscenes/ablation/vampire2_r50_256x704_24e_lss_inpaintor_depth.py -t -b 1 --gpus 8 --ckpt_path ...
    run_cli(VAMPIRELightningModel,
            'ablation/vampire2_r50_256x704_24e_lss_inpaintor_depth')