...
from src.models.lss import LSS
...
class VAMPIRELightningModel(BaseVAMPIRELightningModel):
    ...
    def __init__(self, **kwargs):
        ...
        self.model = LSS(self.backbone_conf,
                              self.head_conf)

if __name__ == '__main__':
    # train
    # python src/exps/nuscenes/ablation/vampire2_r50_256x704_24e_lss.py --amp_backend native -b 1 --gpus 8
    # test
    # python src/exps/nuscenes/ablation/vampire2_r50_256x704_24e_lss.py -t -b 1 --gpus 8 --ckpt_path ...
    run_cli(VAMPIRELightningModel,
            'ablation/vampire2_r50_256x704_24e_lss')