...
from src.layers.backbones.base_vampire2 import BaseVAMPIRE2
from src.layers.heads.bev_depth_head import BEVDepthHead

__all__ = ['VAMPIRE2']


class VAMPIRE2(nn.Module):
    """
    Args:
    ...
    def __init__(self, backbone_conf, head_conf):
        super(VAMPIRE2, self).__init__()
        self.backbone = BaseVAMPIRE2(**backbone_conf)
    ...
    def forward(
        ...
        pts_logits_batch, pts_sdf_batch, occ_logits_batch, occ_density_batch = self.backbone(x, mats_dict, inrange_pts,
                                                                                             timestamps)
