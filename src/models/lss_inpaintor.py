...
from src.layers.backbones.base_lss_impaintor import BaseLSSImpaintor
from src.layers.heads.bev_depth_head import BEVDepthHead

__all__ = ['LSSInpaintor']


class LSSInpaintor(nn.Module):
    """
    Args:
    ...
    def __init__(self, backbone_conf, head_conf):
        super(LSSInpaintor, self).__init__()
        self.backbone = BaseLSSImpaintor(**backbone_conf)
